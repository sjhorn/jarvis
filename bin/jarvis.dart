...
Future<void> runSetup(List<String> args) async {
  ...
  if (!await File(configPath).exists()) {
    ...
    if (sherpaLib != null) print('  Found sherpa-onnx: $sherpaLib');

    final configContent = '''
# JARVIS Configuration
# Generated by: jarvis setup

# Whisper (speech-to-text) - model downloaded by setup
...
''';
    ...
    if (missingTools.isEmpty) {
      ...
      if (missingTools.contains('whisper-cli')) {
        print('   - whisper-cli: Build from https://github.com/ggerganov/whisper.cpp');
      }
